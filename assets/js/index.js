...
//     setTimeout(() => {
//       $m.removeClass('opacity-0');
//       $m.find('.modal-panel').removeClass('scale-95 opacity-0').addClass('scale-100 opacity-100');
//     }, 10);
//   }

//   function closeModal($m) {
//     $m.find('.modal-panel').removeClass('scale-100 opacity-100').addClass('scale-95 opacity-0');
//     setTimeout(() => {
...
//   // إغلاق
//   $(document).on('click', '#btn-close-loginModal', function() {
//     closeModal($(this).closest('#loginModal'));
//   });
//   $(document).on('click', '#loginModal', function (e) {
//     // فقط إذا النقرة على العنصر نفسه مش على الأطفال
//     if (e.target === this) {
//       closeModal($(this));
//     }
//   });
